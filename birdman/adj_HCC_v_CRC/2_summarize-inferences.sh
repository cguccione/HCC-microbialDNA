...
#SBATCH --chdir=/panfs/cguccion/22_06_22_HCC_CRC_Amir/HCC-microbialDNA/birdman/adj_HCC_v_CRC
...
for inference_dir in glob.glob('/panfs/cguccion/22_06_22_HCC_CRC_Amir/HCC-microbialDNA/birdman/adj_HCC_v_CRC/inferences/*'):
