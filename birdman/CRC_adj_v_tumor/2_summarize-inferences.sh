...
#SBATCH --chdir=/panfs/cguccion/22_06_22_HCC_CRC_Amir/HCC-microbialDNA/birdman/CRC_adj_v_tumor
...
for inference_dir in glob.glob('/panfs/cguccion/22_06_22_HCC_CRC_Amir/HCC-microbialDNA/birdman/CRC_adj_v_tumor/inferences/*'):
